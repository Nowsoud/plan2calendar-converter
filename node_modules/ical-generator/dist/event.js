...
var ICalEvent = function () {
    function ICalEvent(data, _calendar) {
        ...
        this._attributes = ['id', 'uid', 'sequence', 'start', 'end', 'timezone', 'stamp', 'timestamp', 'allDay', 'floating', 'repeating', 'summary', 'location', 'description', 'htmlDescription', 'organizer', 'attendees', 'alarms', 'categories', 'status', 'busystatus', 'url', 'created', 'lastModified'];
        this._vars = {
